      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300">
              Your premier destination for luxury timepieces. We offer authentic, high-quality watches from the world's most prestigious brands.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/sizing" className="text-gray-300 hover:text-white transition-colors">Sizing Guide</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Luxury Watch Shop. All rights reserved.
          </p>
